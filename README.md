...
Change Log
    ...
    0.3.4
      ...
      - Users now can choose to display or hide the right side y-axis for the histogram and curve modules, by setting "rightsideY = TRUE" or "rightsideY = FALSE", respectively.
      - Bug fixes
